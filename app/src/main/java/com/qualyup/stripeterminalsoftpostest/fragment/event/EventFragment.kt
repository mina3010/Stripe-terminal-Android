...
import com.qualyup.stripeterminalsoftpostest.NavigationListener
import com.qualyup.stripeterminalsoftpostest.R
import com.qualyup.stripeterminalsoftpostest.databinding.FragmentEventBinding
import com.qualyup.stripeterminalsoftpostest.fragment.TerminalFragment
...
import com.qualyup.stripeterminalsoftpostest.network.ApiClient
import com.qualyup.stripeterminalsoftpostest.viewmodel.EventViewModel
...
class EventFragment : Fragment(), BluetoothReaderListener {
    ...
    companion object {
        const val TAG = "com.qualyup.stripeterminalsoftpostest.fragment.event.EventFragment"

        private const val AMOUNT = "com.qualyup.stripeterminalsoftpostest.fragment.event.EventFragment.amount"
        private const val CURRENCY = "com.qualyup.stripeterminalsoftpostest.fragment.event.EventFragment.currency"
        private const val REQUEST_PAYMENT = "com.qualyup.stripeterminalsoftpostest.fragment.event.EventFragment.request_payment"
        private const val READ_REUSABLE_CARD = "com.qualyup.stripeterminalsoftpostest.fragment.event.EventFragment.read_reusable_card"
        private const val SKIP_TIPPING = "com.qualyup.stripeterminalsoftpostest.fragment.event.EventFragment.skip_tipping"
        private const val EXTENDED_AUTH = "com.qualyup.stripeterminalsoftpostest.fragment.event.EventFragment.extended_auth"
        private const val INCREMENTAL_AUTH = "com.qualyup.stripeterminalsoftpostest.fragment.event.EventFragment.incremental_auth"
