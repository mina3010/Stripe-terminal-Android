package com.qualyup.stripeterminalsoftpostest
...
import com.qualyup.stripeterminalsoftpostest.fragment.ConnectedReaderFragment
import com.qualyup.stripeterminalsoftpostest.fragment.PaymentFragment
import com.qualyup.stripeterminalsoftpostest.fragment.TerminalFragment
import com.qualyup.stripeterminalsoftpostest.fragment.UpdateReaderFragment
import com.qualyup.stripeterminalsoftpostest.fragment.discovery.DiscoveryFragment
import com.qualyup.stripeterminalsoftpostest.fragment.event.EventFragment
import com.qualyup.stripeterminalsoftpostest.fragment.location.LocationCreateFragment
import com.qualyup.stripeterminalsoftpostest.fragment.location.LocationSelectionController
import com.qualyup.stripeterminalsoftpostest.fragment.location.LocationSelectionFragment
import com.qualyup.stripeterminalsoftpostest.network.TokenProvider
...
class MainActivity :
    ...
    private fun verifyGpsEnabled(): Boolean {
        ...
        if (!gpsEnabled) {
            // notify user
            AlertDialog.Builder(ContextThemeWrapper(this, com.google.android.material.R.style.Theme_MaterialComponents_DayNight_DarkActionBar))
